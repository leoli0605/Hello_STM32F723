...
docker exec "%CONTAINER_NAME%" sh -c "cd /share && git submodule update --init --recursive && cp assets/utility_config.h Drivers/cUtils/utility_config.h && make clean && make"
